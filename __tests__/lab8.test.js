describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    await button.click();
    let innerText = await (await button.getProperty('innerHTML')).jsonValue();
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    // let innerText =  cartCount.innerText();
    let value = await (await cartCount.getProperty('innerHTML')).jsonValue();
    // let value = await innerText.jsonValue();
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for (let i = 0; i < prodItems.length; i++) {
      ...
      let button = await shadowRoot.$('button');
      // await button.click();
      let value = await (await button.getProperty('innerHTML')).jsonValue();
